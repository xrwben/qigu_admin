          ...
          <div class="wrapper">
            <div class="info">
              <div>
                ...
                <span class="right">
                  <input v-model.trim="serviceData.people1"/>
                  <i>~</i>
                  <input v-model.trim="serviceData.people2"/>
                </span>
              </div>
              <div><span class="left">开通时长(年)：</span><span class="right"><input type="text" v-model.trim="serviceData.time" value=""/></span></div>
              <div>
                <span class="left">价格(元)：</span>
                <span class="right">
                  <input v-model.trim="serviceData.price" value=""/>
                </span></div>
            </div>
          </div>
          <div class="foot">
