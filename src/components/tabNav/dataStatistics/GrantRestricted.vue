  ...
  <div id="employeeCertification">
    <div v-show="!showPopup">
      ...
      <el-table :data="tableDatas" resizable>
        ...
        <el-table-column label="认购日期" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button size="small" type="success" @click="viewDetails(scope.row.limitationId)">详细</el-button>
          </template>
        </el-table-column>
      </el-table>
        ...
        <el-col :span="16" class="popup" >
          ...
          <div class="wrapper">
            <div class="info">
              ...
              <p><span>类型：</span><span>受限股</span></p>
              ...
              <p><span>总股数：</span><span>{{ limitation.subscribeNum }}</span></p>
              <p><span>已解限（股）：</span><span>{{ limitation.notLimit }}</span></p>
              <p><span>认购价（元/股）：</span><span>{{ limitation.subscribePrice }}</span></p>
              <p><span>认购日期：</span><span>{{ limitation.createTime | dateFormat }}</span></p>
            </div>
            <div class="idCard">
              <h3>文档</h3>
              <a href="javascript:void(0)" @click="downLoad">受限股认购确认书</a>
            </div>
            <div class="noLimit">
              <label>解限计划详情</label>
              <ul>
  ...
  export default {
    ...
    methods: {
      ...
      getDatas () {
        this.axios({
          method: 'get',
          url: '/keygood/admin/limitation/findbylike',
          params: {
      ...
      viewDetails (id) {
        ...
        this.axios({
          method: 'get',
          url: '/keygood/admin/limitation/findOne',
          params: {
            limitationId: id
          }
        }).then((result) => {
